...
`Text` component is a basic text component in COUI, used to display text content. It supports customizing various text styles, alignment, and decoration effects.
...
COUI provides multiple predefined text styles:
