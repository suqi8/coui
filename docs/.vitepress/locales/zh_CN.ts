            ...
            "/zh_CN/guide/": [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: "导航支持", link: "/zh_CN/guide/coui-nav" },
            ...
            "/zh_CN/components/": [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: "LoadingButton", link: "/zh_CN/components/loadingbutton" },
                        ...
                        { text: "InputView", link: "/zh_CN/components/inputview" },
                        { text: "CodeTextField", link: "/zh_CN/components/codetextfield" },
                        ...
                        { text: "Stepper", link: "/zh_CN/components/stepper" },
                        { text: "DatePicker", link: "/zh_CN/components/datepicker" },
                        { text: "TimePicker", link: "/zh_CN/components/timepicker" },
                        { text: "ProgressIndicator", link: "/zh_CN/components/progressindicator", },
                        { text: "Snackbar", link: "/zh_CN/components/snackbar" },
                        { text: "TopTips", link: "/zh_CN/components/toptips" },
                        { text: "Tooltip", link: "/zh_CN/components/tooltip" },
                        { text: "Badge", link: "/zh_CN/components/badge" },
                        { text: "Chip", link: "/zh_CN/components/chip" },
                        ...
                        { text: "FullPageStatement", link: "/zh_CN/components/fullpagestatement" },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: "SwitchLoadingPreference", link: "/zh_CN/components/switchloadingpreference" },
                        ...
                        { text: "MarkPreference", link: "/zh_CN/components/markpreference" },
                        ...
                        { text: "ButtonPreference", link: "/zh_CN/components/buttonpreference" },
                        { text: "ListPreference", link: "/zh_CN/components/listpreference" },
                        { text: "RecommendedPreference", link: "/zh_CN/components/recommendedpreference" },
