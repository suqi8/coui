 ...
 *
 * Item clicks call [com.suqi8.coui.kmp.basic.DropdownItem.onClick], and [collapseOnSelection]
 ...
 *
 * Groups are separated by dividers. Item clicks call [com.suqi8.coui.kmp.basic.DropdownItem.onClick], and [collapseOnSelection]
 * controls whether the dialog is dismissed after a click.
 */
@Composable
fun WindowDropdownDialog(
