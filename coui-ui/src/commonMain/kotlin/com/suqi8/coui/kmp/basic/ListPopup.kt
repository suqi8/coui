...
import com.suqi8.coui.kmp.squircle.isSquircleEnabled
...
/**
 * Drop shadow of the popup container. COUI clips the popup in a RoundFrameLayout with
 * OUTLINE_CLIP mode, which applies ShadowUtils.setElevationToView(view, SHADOW_LV4) on OPlus
 * devices, or elevation = support_shadow_size_level_five (30dp) with spot shadow color
 * coui_popup_outline_spot_shadow_color (#80000000) elsewhere. Approximated here as a soft
 * black drop shadow; shared with the cascading popup surfaces so main and cascading menus
