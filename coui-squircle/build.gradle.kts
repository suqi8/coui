...
couiPublication {
    description.set("Squircle corner library for COUI")
}
...
abstract class BakeSquircleSdfTask : DefaultTask() {
    ...
    fun bake() {
        ...
        val source =
            buildString {
                appendLine("// Copyright 2026, compose-coui-ui contributors")
                appendLine("// SPDX-License-Identifier: Apache-2.0")
                appendLine()
                appendLine("// Auto-generated by :coui-squircle:bakeSquircleSdf -- do not edit.")
                appendLine()
