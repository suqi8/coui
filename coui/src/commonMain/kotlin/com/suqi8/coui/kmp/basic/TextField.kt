...
fun TextField(
    ...
    label: String = "",
    labelColor: Color = COUITheme.colorScheme.onSecondaryContainer,
    borderColor: Color = COUITheme.colorScheme.primary,
    useLabelAsPlaceholder: Boolean = false,
    enabled: Boolean = true,
    readOnly: Boolean = false,
    inputTransformation: InputTransformation? = null,
    textStyle: TextStyle = COUITheme.textStyles.main,
...
fun TextField(
    ...
    interactionSource: MutableInteractionSource? = null,
    cursorBrush: Brush = SolidColor(COUITheme.colorScheme.primary)
) {
    @Suppress("NAME_SHADOWING")
    val interactionSource = interactionSource ?: remember { MutableInteractionSource() }
    val isFocused by interactionSource.collectIsFocusedAsState()
