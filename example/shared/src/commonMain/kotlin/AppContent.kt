...
import com.suqi8.coui.kmp.basic.NavigationRailValue
...
import com.suqi8.coui.kmp.basic.rememberNavigationRailState
...
import com.suqi8.coui.kmp.nav.core.NavCornerClipMode
...
import com.suqi8.coui.kmp.nav.core.rememberNavSystemCornerRadius
...
private object UIConstants {
    ...
    const val GITHUB_URL = "https://github.com/compose-coui-ui/miuix"
...
fun AppContent(
    ...
    // coui-nav back stack. The explicit <Route> supertype is required: a bare
    // rememberNavBackStack(Route.Main) would infer T = the Route.Main singleton type and fail to
    // encode the whole sealed hierarchy for save/restore. coui-nav is reflection-free, so no
    ...
    val navigationItems = remember {
        listOf(
            NavigationItem(UIConstants.PAGE_TITLES[0], COUIIcons.Home),
    ...
    CompositionLocalProvider(
        ...
        val backdropColor = COUITheme.colorScheme.surface
        ...
        // Swipe-to-dismiss is opt-in in coui-nav and off by default; the example gates it behind a
